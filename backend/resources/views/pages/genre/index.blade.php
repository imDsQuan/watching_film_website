...
@section('content')
    <div class="main">
        ...
        <div class="container">
            <div class="row">
                <a href="/genre" class="col-4 text-decoration-none">
                ...
                <a href="#" class="col-4 text-decoration-none">
                    <div class="card m-2 bg-info p-2">
                        <div class="card-body d-flex justify-content-center align-content-center text-white">
                            ...
                            <span class="font-weight-bold ml-1" style="font-size: 24px;"> {{$totalGenre}} Genre</span>
                        </div>
                    </div>
                </a>
                <a href="/genre/create" class="col-4 text-decoration-none">
            ...
            <div class="row" id="news-container">
                ...
                <div class="col-3 my-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                                <h5 class="card-title text-center">{{$genre['title']}}</h5>
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="/genre/{{$genre['title']}}/edit" class="btn btn-warning mx-2"><ion-icon name="build-outline"></ion-icon></a>
                                    ...
                                    <a href="/genre/{{$genre['id']}}/up" class="btn btn-info mx-2"><ion-icon name="chevron-up-outline"></ion-icon></a>
                                    <a href="/genre/{{$genre['id']}}/down" class="btn btn-info mx-2"><ion-icon name="chevron-down-outline"></ion-icon></a>
                                </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#btn-delete-genre').on('click', function () {
                $.ajax({
                    url: "http://localhost:8000/" + "genre/delete/" + deleteId,
                    method: "POST",
                    dataType: "json",
                    success: function () {
