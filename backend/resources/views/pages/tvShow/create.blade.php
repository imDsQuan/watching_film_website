        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-start">
                    ...
                    <div class="font-weight-bold ml-2" style="font-size: 32px;">New TV Show</div>
                </div>
                <div class="card-body">
                    <form action="/tvShow" method="POST" enctype='multipart/form-data'>
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-4">
                                <div class="fileinput">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <label for="year">TV Show Year</label>
                                    <input type="text" class="form-control" id="year" name="year" required>
                                </div>
                                <div class="form-group">
                                    <label for="imdb">TV Show IMDB Rating</label>
                                    <input type="text" class="form-control" id="imdb" name="imdb" required>
                                </div>
                                <div class="form-group">
                                    <label for="duration">TV Show Duration</label>
