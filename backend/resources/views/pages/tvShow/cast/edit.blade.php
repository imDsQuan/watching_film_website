        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-start">
                    ...
                    <div class="font-weight-bold ml-2" style="font-size: 32px;">Edit Actor "{{$actor->name}}"</div>
                </div>
                <div class="card-body">
                    <form action="/tvShow/{{$tvShow->slug}}/cast/{{$role->id}}/update" method="POST" enctype='multipart/form-data'>
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="/tvShow/{{$tvShow->slug}}/cast" class="btn btn-secondary  mt-4">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
