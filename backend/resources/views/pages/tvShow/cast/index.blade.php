            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center justify-content-start">
                        ...
                        <div class="font-weight-bold ml-2" style="font-size: 32px;">Actors Of "{{$tvShow->title}}"</div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-3 my-3">
                            <div class="card" style="height: 360px">
                                ...
                                <div class="card-body text-center">
                                    <form action="/tvShow/{{$tvShow->slug}}/cast" method="POST">
                                            {{ csrf_field() }}
                                        <input type="text" class="form-control mb-2 text-center" name="poster_id" value="{{$tvShow->id}}" hidden required>
    ...
    <script>
            ...
            $(document).ready(function (){
                $('#btn-delete-cast').on('click', function () {
                    $.ajax({
                        url: "http://localhost:8000/" + "tvShow/{{$tvShow->id}}/cast/" + deleteId + "/delete",
                        method: "POST",
                        dataType: "json",
                        success: function () {
