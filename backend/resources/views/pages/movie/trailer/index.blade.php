    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/movie/{{$movie->id}}/trailer" method="POST" enctype='multipart/form-data'>
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="trailer_url">Add Trailer Youtube Url</label>
                                    <input type="text" class="form-control" id="trailer_url" name="trailer_url" value="{{$movie->trailer}}" required>
                                </div>
