...
@section('content')
        ...
        <div class="container">
            ...
            <div class="card card-stats card-initial" style="margin: 15px 0;">
                ...
                <div class="tab-moivie">
                    <a href="/movie/{{$movie->slug}}/edit" class="btn btn-tab-movie-active d-flex justify-content-center align-items-center"><ion-icon name="add-circle-outline" style="font-size:16px; margin-right:8px;"></ion-icon> Edit</a>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="fileinput">
                                    ...
                                    <img class="img-preview  img-thumbnail" src="{{$movie->img_thumbnail}}" alt="">
                                </div>
                            </div>
                            <div class="col">
                                <input type="text" class="form-control" name="id" value="{{$movie->id}}" hidden required>
                                ...
                                <div class="fileinput">
                                    ...
                                    <img class="img-preview img-cover" src="{{$movie->img_cover}}" alt="">
                                </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="label" name="label" value="{{$movie->label}}" required>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="subLabel">Sub-label</label>
                                            <input type="text" class="form-control" id="subLabel" name="subLabel" value="{{$movie->subLabel}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="imdb" name="imdb" value="{{$movie->imdb}}" required>
                                </div>
                                <div class="form-group">
    ...
    <script>
        $(document).ready(function(){
            ...
            let listGenre = Object.values(<?php echo $movie->genres ?>);
