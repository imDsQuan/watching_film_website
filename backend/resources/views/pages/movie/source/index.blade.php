            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center justify-content-start">
                        ...
                        <div class="font-weight-bold ml-2" style="font-size: 32px;">Source Of "{{$movie->title}}"</div>
                    </div>
                    <a href="/movie/{{$movie->id}}/source/create" class="text-decoration-none float-right">
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <a href="/movie/{{$movie->id}}/source/{{$source->id}}/edit " class="btn btn-warning mr-2"><ion-icon name="build-outline"></ion-icon></a>
    ...
    <script>
        $(document).ready(function (){
            $('#btn-delete-source').on('click', function () {
                $.ajax({
                    url: "http://localhost:8000/" + "movie/{{$movie->id}}/source/{{$source->id}}/delete",
                    method: "POST",
                    dataType: "json",
                    success: function () {
