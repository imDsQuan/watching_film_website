        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-start">
                    ...
                    <div class="font-weight-bold ml-2" style="font-size: 32px;">New Source Of "{{$movie->title}}"</div>
                </div>
                <div class="card-body">
                    <form action="/movie/{{$movie->id}}}/source" method="POST" enctype='multipart/form-data'>
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="/movie" class="btn btn-secondary  mt-4">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
